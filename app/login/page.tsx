    ...
    return (
        <div className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center p-6 selection:bg-indigo-500/30">
            <Link href="/" className="mb-12 flex items-center gap-2 group transition-all">
                ...
                <span className="text-2xl font-black tracking-tighter italic text-white">VIBEFLOW</span>
            </Link>
            ...
            <div className="w-full max-w-md">
                ...
                <p className="mt-8 text-center text-zinc-500 text-sm">
                    ...
                    <Link href="/apply" className="text-white font-bold hover:underline underline-offset-4 transition-all ml-1">
                        Request Access
                    </Link>
                </p>
            </div>
